...
execute if block ~ ~ ~ minecraft:brewing_stand run function nations:enchanter/modify_brewing_stand
...
execute if score #raycast_temp nations_temp matches ..10 positioned ^ ^ ^0.5 run function nations:enchanter/raycast_brewing_stand
