...
execute if block ~ ~ ~ minecraft:enchanting_table run function nations:enchanter/blood_mend
...
execute if score #raycast_temp nations_temp matches ..10 positioned ^ ^ ^0.5 run function nations:enchanter/raycast_mend
