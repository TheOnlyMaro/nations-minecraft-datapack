...
execute unless data entity @s SelectedItem run tellraw @s {"text":"No item in hand to send!","color":"red"}
execute unless data entity @s SelectedItem run return fail

execute unless entity @s[level=5..] run tellraw @s {"text":"Not enough XP!","color":"red"}
