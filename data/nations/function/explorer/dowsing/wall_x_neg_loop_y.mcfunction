# nations:explorer/dowsing/wall_x_neg_loop_y
# Y loop for left wall
...
# Start Z loop
function nations:explorer/dowsing/wall_x_neg_loop_z with storage nations:dowsing

# Increment Y and continue
scoreboard players add #scan_y nations_pid 1
execute if score #found nations_pid matches 0 run function nations:explorer/dowsing/wall_x_neg_loop_y with storage nations:dowsing
