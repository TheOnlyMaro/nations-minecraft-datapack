# nations:explorer/dowsing/wall_z_pos_loop_x
# X loop for front wall
...
# Start Y loop
function nations:explorer/dowsing/wall_z_pos_loop_y with storage nations:dowsing

# Increment X and continue
scoreboard players add #scan_x nations_pid 1
execute if score #found nations_pid matches 0 run function nations:explorer/dowsing/wall_z_pos_loop_x with storage nations:dowsing
