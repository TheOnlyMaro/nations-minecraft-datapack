# nations:explorer/dowsing/wall_x_neg_loop_z
# Z loop for left wall
...
# Check this position
function nations:explorer/dowsing/check_position with storage nations:dowsing

# Increment Z and continue
scoreboard players add #scan_z nations_pid 1
execute if score #found nations_pid matches 0 run function nations:explorer/dowsing/wall_x_neg_loop_z with storage nations:dowsing
