# nations:explorer/dowsing/wall_z_neg_loop_y
# Y loop for back wall
...
function nations:explorer/dowsing/check_position_z_neg with storage nations:dowsing

# Increment Y and continue
scoreboard players add #scan_y nations_pid 1
execute if score #found nations_pid matches 0 run function nations:explorer/dowsing/wall_z_neg_loop_y with storage nations:dowsing
