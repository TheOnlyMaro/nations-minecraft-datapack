# nations:explorer/dowsing/wall_y_neg_loop_x
# X loop for bottom
...
# Start Z loop
function nations:explorer/dowsing/wall_y_neg_loop_z with storage nations:dowsing

# Increment X and continue
scoreboard players add #scan_x nations_pid 1
execute if score #found nations_pid matches 0 run function nations:explorer/dowsing/wall_y_neg_loop_x with storage nations:dowsing
